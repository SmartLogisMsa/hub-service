...
public enum HubRouteMessageCode implements MessageCode {
    ...
    // 허브 조회 관련
    HUB_ROUTE_START_HUB_NOT_FOUND("HUB_ROUTE.START_HUB_NOT_FOUND", HttpStatus.NOT_FOUND),
    HUB_ROUTE_END_HUB_NOT_FOUND("HUB_ROUTE.END_HUB_NOT_FOUND", HttpStatus.NOT_FOUND),

    // Relay Hub 관련
    HUB_ROUTE_RELAY_HUB_NOT_FOUND("HUB_ROUTE.RELAY_HUB_NOT_FOUND", HttpStatus.NOT_FOUND),
    ...
    // 외부 API 오류
    HUB_ROUTE_DIRECTION_API_FAILED("HUB_ROUTE.DIRECTION_API_FAILED", HttpStatus.BAD_GATEWAY);
